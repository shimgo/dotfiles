...
vim.keymap.set("n", "<leader>fgg", ":lua require'fzf-lua'.grep({ cmd = 'git grep -i --line-number --column --color=always' })<CR>") -- Git管理のファイルをcase-insensitiveでgrep
vim.keymap.set("n", "<leader>fgc", ":lua require'fzf-lua'.grep({ cmd = 'git grep --line-number --column --color=always' })<CR>") -- Git管理のファイルをcase-sensitiveでgrep
